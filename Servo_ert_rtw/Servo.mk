###########################################################################
## Makefile generated for Simulink model 'Servo'. 
## 
## Makefile     : Servo.mk
## Generated on : Mon Apr 10 11:53:22 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Servo.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Servo_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Servo.elf
...
DEFINES_ = -DMODEL=Servo -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=6 -DMW_SCHEDULERCOUNTER=75 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=6
...
DEFINES_STANDARD = -DMODEL=Servo -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/Servo_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Servo_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/Servo_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
