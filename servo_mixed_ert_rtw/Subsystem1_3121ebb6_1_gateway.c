...
#include "nesl_rtw.h"
#include "Subsystem1_3121ebb6_1.h"

void Subsystem1_3121ebb6_1_gateway(void)
{
  ...
  NeDae* dae[1];
  size_t numOutputs = 0;
  Subsystem1_3121ebb6_1_dae(&dae[0],
    &modelparams,
    &solverparams,
    linear_algebra_ptr);
  nesl_register_simulator_group(
    "Subsystem1/Subsystem1/Simulation/Solver Configuration_1",
    1,
    &dae[0],
    solverparams,
    modelparams,
