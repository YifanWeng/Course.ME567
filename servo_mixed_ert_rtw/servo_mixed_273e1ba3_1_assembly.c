...
void servo_mixed_273e1ba3_1_resetStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void servo_mixed_273e1ba3_1_initializeTrackedAngleState(const void *mech, const
...
void servo_mixed_273e1ba3_1_computeDiscreteState(const void *mech, double *state)
{
  (void) mech;
  (void) state;
}

void servo_mixed_273e1ba3_1_adjustPosition(const void *mech, const double
...
void servo_mixed_273e1ba3_1_perturbState(const void *mech, size_t stageIdx,
...
void servo_mixed_273e1ba3_1_computeDofBlendMatrix(const void *mech, size_t
...
void servo_mixed_273e1ba3_1_projectPartiallyTargetedPos(const void *mech, size_t
...
void servo_mixed_273e1ba3_1_propagateMotion(const void *mech, const double
...
size_t servo_mixed_273e1ba3_1_computeAssemblyError(const void *mech, size_t
...
size_t servo_mixed_273e1ba3_1_computeAssemblyJacobian(const void *mech, size_t
...
size_t servo_mixed_273e1ba3_1_computeFullAssemblyJacobian(const void *mech,
...
int servo_mixed_273e1ba3_1_isInKinematicSingularity(const void *mech, size_t
...
PmfMessageId servo_mixed_273e1ba3_1_convertStateVector(const void *asmMech,
...
void servo_mixed_273e1ba3_1_constructStateVector(const void *mech, const double *
...
void servo_mixed_273e1ba3_1_extractSolverStateVector(const void *mech, const
...
int servo_mixed_273e1ba3_1_isPositionViolation(const void *mech, const double
  *state)
{
  (void) mech;
  (void) state;
...
int servo_mixed_273e1ba3_1_isVelocityViolation(const void *mech, const double
  *state)
{
  (void) mech;
  (void) state;
...
PmfMessageId servo_mixed_273e1ba3_1_projectStateSim(const void *mech, const
