###########################################################################
## Makefile generated for Simulink model 'servo_mixed'. 
## 
## Makefile     : servo_mixed.mk
## Generated on : Mon Apr 10 23:30:03 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/servo_mixed.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = servo_mixed_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/servo_mixed.elf
...
DEFINES_ = -DMODEL=servo_mixed -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DRT -DUSE_RTMODEL -DERT -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=6 -DMW_SCHEDULERCOUNTER=75 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=6
...
DEFINES_STANDARD = -DMODEL=servo_mixed -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = Simulation_f1e64dd8_1.o Simulation_f1e64dd8_1_assembly.o Simulation_f1e64dd8_1_checkDynamics.o Simulation_f1e64dd8_1_computeConstraintError.o Simulation_f1e64dd8_1_create.o Simulation_f1e64dd8_1_deriv.o Simulation_f1e64dd8_1_gateway.o Subsystem1_3121ebb6_1.o Subsystem1_3121ebb6_1_assembly.o Subsystem1_3121ebb6_1_checkDynamics.o Subsystem1_3121ebb6_1_computeConstraintError.o Subsystem1_3121ebb6_1_create.o Subsystem1_3121ebb6_1_deriv.o Subsystem1_3121ebb6_1_gateway.o pm_printf.o rtGetInf.o rtGetNaN.o rt_backsubrr_dbl.o rt_forwardsubrr_dbl.o rt_lu_real.o rt_matrixlib_dbl.o rt_nonfinite.o rt_sfcn_helper.o servo_mixed.o servo_mixed_273e1ba3_1.o servo_mixed_273e1ba3_1_assembly.o servo_mixed_273e1ba3_1_checkDynamics.o servo_mixed_273e1ba3_1_computeConstraintError.o servo_mixed_273e1ba3_1_create.o servo_mixed_273e1ba3_1_deriv.o servo_mixed_273e1ba3_1_gateway.o rt_matrx.o rt_printf.o updown.o ext_work.o rtiostream_utils.o Subsystem1_sf.o hooks.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_pulse.o wiring_shift.o abi.o CDC.o HardwareSerial.o HardwareSerial0.o HardwareSerial1.o HardwareSerial2.o HardwareSerial3.o PluggableUSB.o IPAddress.o new.o Print.o Stream.o Tone.o USBCore.o WMath.o WString.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface_arduino.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o Servo.o
...
%.o : $(START_DIR)/servo_mixed_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/servo_mixed_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/servo_mixed_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
