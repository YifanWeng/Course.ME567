...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
PmfMessageId Subsystem1_3121ebb6_1_deriv(
  const double *,
...
PmfMessageId Subsystem1_3121ebb6_1_checkDynamics(
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId Subsystem1_3121ebb6_1_outputDyn(
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId Subsystem1_3121ebb6_1_outputKin(
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId Subsystem1_3121ebb6_1_output (
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
void Subsystem1_3121ebb6_1_resetStateVector(const void *mech, double
  *stateVector);
void Subsystem1_3121ebb6_1_initializeTrackedAngleState(
  const void *mech,
  const double *motionData,
  double *stateVector,
  void *neDiagMgr);
void Subsystem1_3121ebb6_1_computeDiscreteState(const void *mech, double
  *stateVector);
void Subsystem1_3121ebb6_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void Subsystem1_3121ebb6_1_perturbState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void Subsystem1_3121ebb6_1_computeDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void Subsystem1_3121ebb6_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void Subsystem1_3121ebb6_1_propagateMotion(
  const void *mech,
  const double *stateVector,
  double *motionData);
size_t Subsystem1_3121ebb6_1_computeAssemblyError(
  const void *mech,
  size_t constraintIdx,
  const double *stateVector,
  const double *motionData,
  double *error);
size_t Subsystem1_3121ebb6_1_computeAssemblyJacobian(
  const void *mech,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t Subsystem1_3121ebb6_1_computeFullAssemblyJacobian(
  const void *mech,
  const double *stateVector,
  const double *motionData,
  double *J);
int Subsystem1_3121ebb6_1_isInKinematicSingularity(
  const void *mech,
  size_t constraintIdx,
  const double *motionData);
PmfMessageId Subsystem1_3121ebb6_1_convertStateVector(
  const void *asmMech,
  const void *simMech,
  const double *asmStateVector,
  double *simStateVector,
  void *neDiagMgr);
void Subsystem1_3121ebb6_1_constructStateVector(
  const void *mech,
...
void Subsystem1_3121ebb6_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
int Subsystem1_3121ebb6_1_isPositionViolation(
  const void *mech,
  const double *stateVector);
int Subsystem1_3121ebb6_1_isVelocityViolation(
  const void *mech,
  const double *stateVector);
PmfMessageId Subsystem1_3121ebb6_1_projectStateSim(
  const void *mech,
  const double *inputVector,
  double *stateVector,
  void *neDiagMgr);
void Subsystem1_3121ebb6_1_computeConstraintError(
  const void *mech,
  const double *stateVector,
  double *error);
PmfMessageId Subsystem1_3121ebb6_1_assemble(const double *u, double *udot,
  double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = Subsystem1_3121ebb6_1_deriv(
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 7,
      systemInput->mV.mX + 7,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL && smData->mDoCheckDynamics) {
    double result = 0.0;
    errorId = Subsystem1_3121ebb6_1_checkDynamics(
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 7,
      systemInput->mV.mX + 7,
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector = Subsystem1_3121ebb6_1_resetStateVector;
  delegate->mInitializeTrackedAngleState =
    Subsystem1_3121ebb6_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState = Subsystem1_3121ebb6_1_computeDiscreteState;
  delegate->mAdjustPosition = Subsystem1_3121ebb6_1_adjustPosition;
  delegate->mPerturbState = Subsystem1_3121ebb6_1_perturbState;
  delegate->mComputeDofBlendMatrix = Subsystem1_3121ebb6_1_computeDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    Subsystem1_3121ebb6_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = Subsystem1_3121ebb6_1_propagateMotion;
  delegate->mComputeAssemblyError = Subsystem1_3121ebb6_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    Subsystem1_3121ebb6_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    Subsystem1_3121ebb6_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    Subsystem1_3121ebb6_1_isInKinematicSingularity;
  delegate->mConvertStateVector = Subsystem1_3121ebb6_1_convertStateVector;
  delegate->mConstructStateVector = Subsystem1_3121ebb6_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    Subsystem1_3121ebb6_1_extractSolverStateVector;
  delegate->mIsPositionViolation = Subsystem1_3121ebb6_1_isPositionViolation;
  delegate->mIsVelocityViolation = Subsystem1_3121ebb6_1_isVelocityViolation;
  delegate->mProjectStateSim = Subsystem1_3121ebb6_1_projectStateSim;
  delegate->mComputeConstraintError =
    Subsystem1_3121ebb6_1_computeConstraintError;
  delegate->mMech = NULL;
}
...
void Subsystem1_3121ebb6_1_NeDaePrivateData_create(NeDaePrivateData *smData)
{
