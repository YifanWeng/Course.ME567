...
MODEL              = Simulation
MODULES            = Simulation_f1e64dd8_1.c Simulation_f1e64dd8_1_assembly.c Simulation_f1e64dd8_1_checkDynamics.c Simulation_f1e64dd8_1_computeConstraintError.c Simulation_f1e64dd8_1_create.c Simulation_f1e64dd8_1_deriv.c Simulation_f1e64dd8_1_gateway.c pm_printf.c rtGetInf.c rtGetNaN.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c 
...
COMPUTER           = GLNXA64
MEXEXT             = mexa64
BUILDARGS          =  MODELLIB=Simulationlib.a RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
USERMODULES        =  
CREATEMODEL        = 1
USEPARAMVALUES     = 0
PURIFY             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR)/Simulation_sfcn_rtw \
	-I$(START_DIR) \
