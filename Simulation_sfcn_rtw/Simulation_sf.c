...
#include <math.h>
#include "Simulation_sf.h"
#include "Simulation_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *Simulation_malloc(SimStruct *S);
...
#  endif
...

  {
    ...
    tmp = nesl_lease_simulator("Simulation/Simulation/Solver Configuration_1", 0,
      0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  char *msg;
  B_Simulation_T *_rtB;
  _rtB = ((B_Simulation_T *) ssGetLocalBlockIO(S));
  if (ssIsSampleHit(S, 1, 0)) {
    /* Gain: '<S9>/Gain' incorporates:
     *  Inport: '<Root>/In6'
     */
    _rtB->Gain = -0.5 * *((const real_T **)ssGetInputPortSignalPtrs(S, 5))[0];
  }
   ...
   *  Inport: '<Root>/In2'
   */
  _rtB->INPUT_3_1_1[0] = *((const real_T **)ssGetInputPortSignalPtrs(S, 1))[0];
   ...
   *  Inport: '<Root>/In3'
   */
  _rtB->INPUT_4_1_1[0] = *((const real_T **)ssGetInputPortSignalPtrs(S, 2))[0];
   ...
   *  Inport: '<Root>/In4'
   */
  _rtB->INPUT_5_1_1[0] = *((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0];
   ...
   *  Inport: '<Root>/In5'
   */
  _rtB->INPUT_6_1_1[0] = *((const real_T **)ssGetInputPortSignalPtrs(S, 4))[0];
   ...
   *  Inport: '<Root>/In6'
   */
  _rtB->INPUT_7_1_1[0] = *((const real_T **)ssGetInputPortSignalPtrs(S, 5))[0];
