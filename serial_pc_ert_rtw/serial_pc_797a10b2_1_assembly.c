...
void serial_pc_797a10b2_1_resetStateVector(const void *mech, double *state)
{
  double xx[1];
  (void) mech;
  xx[0] = 0.0;
...
void serial_pc_797a10b2_1_initializeTrackedAngleState(const void *mech, const
...
void serial_pc_797a10b2_1_computeDiscreteState(const void *mech, double *state)
{
  (void) mech;
  (void) state;
}

void serial_pc_797a10b2_1_adjustPosition(const void *mech, const double
...
void serial_pc_797a10b2_1_perturbState(const void *mech, size_t stageIdx, size_t
...
void serial_pc_797a10b2_1_computeDofBlendMatrix(const void *mech, size_t
...
void serial_pc_797a10b2_1_projectPartiallyTargetedPos(const void *mech, size_t
...
void serial_pc_797a10b2_1_propagateMotion(const void *mech, const double *state,
  double *motionData)
{
  double xx[94];
  (void) mech;
  ...
  motionData[6] = - (xx[8] * (xx[23] - xx[12] * xx[4]) - xx[10]);
  motionData[7] = xx[13];
  motionData[8] = xx[14];
  motionData[9] = xx[18];
  motionData[10] = xx[13];
...
size_t serial_pc_797a10b2_1_computeAssemblyError(const void *mech, size_t
...
size_t serial_pc_797a10b2_1_computeAssemblyJacobian(const void *mech, size_t
...
size_t serial_pc_797a10b2_1_computeFullAssemblyJacobian(const void *mech, const
...
int serial_pc_797a10b2_1_isInKinematicSingularity(const void *mech, size_t
...
PmfMessageId serial_pc_797a10b2_1_convertStateVector(const void *asmMech, const
...
void serial_pc_797a10b2_1_constructStateVector(const void *mech, const double
...
void serial_pc_797a10b2_1_extractSolverStateVector(const void *mech, const
...
int serial_pc_797a10b2_1_isPositionViolation(const void *mech, const double
  *state)
{
  (void) mech;
  (void) state;
...
int serial_pc_797a10b2_1_isVelocityViolation(const void *mech, const double
  *state)
{
  (void) mech;
  (void) state;
...
PmfMessageId serial_pc_797a10b2_1_projectStateSim(const void *mech, const double
