###########################################################################
## Makefile generated for Simulink model 'serial_pc'. 
## 
## Makefile     : serial_pc.mk
## Generated on : Mon Apr 10 22:30:54 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/serial_pc.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = serial_pc_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/serial_pc.elf
...
DEFINES_STANDARD = -DMODEL=serial_pc -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/serial_pc_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/serial_pc_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/serial_pc_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
