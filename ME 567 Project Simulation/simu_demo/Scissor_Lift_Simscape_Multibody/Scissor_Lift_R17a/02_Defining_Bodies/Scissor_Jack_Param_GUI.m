...
evalin('base','Scissor_Lift_Param.Roller.Init_Pos_Target = 2-Scissor_Lift_Param.Link.Length;'); % cm 
evalin('base','Scissor_Lift_Param.Crossbar.Init_Angle_Target = 180+asin(Scissor_Lift_Param.Roller.Init_Pos_Target/Scissor_Lift_Param.Link.Length)*180/pi-90;');
