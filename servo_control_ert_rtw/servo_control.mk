...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/servo_control.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = servo_control_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/servo_control.elf
...
%.o : $(START_DIR)/servo_control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/servo_control_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/servo_control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
