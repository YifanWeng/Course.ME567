...
MODEL              = Subsystem2
MODULES            = Subsystem2_266638e5_1.c Subsystem2_266638e5_1_assembly.c Subsystem2_266638e5_1_checkDynamics.c Subsystem2_266638e5_1_computeConstraintError.c Subsystem2_266638e5_1_create.c Subsystem2_266638e5_1_deriv.c Subsystem2_266638e5_1_gateway.c pm_printf.c rtGetInf.c rtGetNaN.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c 
...
COMPUTER           = GLNXA64
MEXEXT             = mexa64
BUILDARGS          =  MODELLIB=Subsystem2lib.a RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING
USERMODULES        =  
CREATEMODEL        = 1
USEPARAMVALUES     = 0
PURIFY             = 0
...
ADD_INCLUDES = \
	-I/root/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinobase/include \
	-I/root/Documents/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arduinobase/blocks/sfcn/include \
	-I$(MATLAB_ROOT)/simulink/include/sf_runtime \
	-I$(START_DIR)/Subsystem2_sfcn_rtw \
	-I$(START_DIR) \
