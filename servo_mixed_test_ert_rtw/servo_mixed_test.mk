...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/servo_mixed_test.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/servo_mixed_test.elf
...
%.o : $(START_DIR)/servo_mixed_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/servo_mixed_test_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/servo_mixed_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
