...
void servo_mixed_test_e8940bbe_1_initializeTrackedAngleState(const void *mech,
...
void servo_mixed_test_e8940bbe_1_adjustPosition(const void *mech, const double
...
void servo_mixed_test_e8940bbe_1_perturbState(const void *mech, size_t stageIdx,
...
void servo_mixed_test_e8940bbe_1_computeDofBlendMatrix(const void *mech, size_t
...
void servo_mixed_test_e8940bbe_1_projectPartiallyTargetedPos(const void *mech,
...
void servo_mixed_test_e8940bbe_1_propagateMotion(const void *mech, const double *
  state, double *motionData)
{
  double xx[94];
  (void) mech;
  ...
  xx[39] = xx[32] * xx[38];
  xx[41] = xx[32] * xx[36];
  xx[43] = - (xx[8] * (xx[36] * xx[39] - xx[38] * xx[41]));
  xx[40] = xx[8] * (xx[36] * xx[41] + xx[38] * xx[39]);
  xx[36] = - xx[40];
  ...
  motionData[2] = xx[3];
  motionData[3] = xx[0];
  motionData[4] = - (xx[2] + xx[8] * (xx[21] - xx[4] * xx[16]));
  ...
  motionData[82] = xx[74] - xx[8] * (xx[75] * xx[46] - xx[83] * xx[47]) + xx[41]
    * state[11];
  motionData[83] = xx[81] - (xx[52] * xx[35] + xx[51] * xx[78]);
  ...
  motionData[88] = xx[89] - xx[8] * (xx[90] * xx[50] - xx[93] * xx[42]) + xx[41]
    * state[13];
  motionData[89] = xx[81] - (xx[44] * xx[35] + xx[49] * xx[78]);
  motionData[90] = xx[92] - xx[8] * (xx[90] * xx[42] + xx[93] * xx[50]) + xx[45]
    * state[13];
}

size_t servo_mixed_test_e8940bbe_1_computeAssemblyError(const void *mech, size_t
...
size_t servo_mixed_test_e8940bbe_1_computeAssemblyJacobian(const void *mech,
  size_t constraintIdx, boolean_T forVelocitySatisfaction, const double *state,
...
size_t servo_mixed_test_e8940bbe_1_computeFullAssemblyJacobian(const void *mech,
...
int servo_mixed_test_e8940bbe_1_isInKinematicSingularity(const void *mech,
  size_t constraintIdx, const double *motionData)
{
  (void) mech;
  (void) motionData;
  switch (constraintIdx)
...
PmfMessageId servo_mixed_test_e8940bbe_1_convertStateVector(const void *asmMech,
  const void *simMech, const double *asmState, double *simState, void
  *neDiagMgr0)
{
  NeuDiagnosticManager *neDiagMgr = (NeuDiagnosticManager *) neDiagMgr0;
  (void) asmMech;
...
void servo_mixed_test_e8940bbe_1_constructStateVector(const void *mech, const
...
void servo_mixed_test_e8940bbe_1_extractSolverStateVector(const void *mech,
...
int servo_mixed_test_e8940bbe_1_isPositionViolation(const void *mech, const
  double *state)
{
  (void) mech;
  (void) state;
...
int servo_mixed_test_e8940bbe_1_isVelocityViolation(const void *mech, const
  double *state)
{
  (void) mech;
  (void) state;
...
PmfMessageId servo_mixed_test_e8940bbe_1_projectStateSim(const void *mech, const
