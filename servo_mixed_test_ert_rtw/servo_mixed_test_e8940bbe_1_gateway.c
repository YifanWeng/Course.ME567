...
#include "nesl_rtw.h"
#include "servo_mixed_test_e8940bbe_1.h"

void servo_mixed_test_e8940bbe_1_gateway(void)
{
  ...
  NeDae* dae[1];
  size_t numOutputs = 0;
  servo_mixed_test_e8940bbe_1_dae(&dae[0],
    &modelparams,
    &solverparams,
    linear_algebra_ptr);
  nesl_register_simulator_group(
    "servo_mixed_test/Subsystem1/Simulation/Solver Configuration_1",
    1,
    &dae[0],
    solverparams,
    modelparams,
