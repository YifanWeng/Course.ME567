...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
PmfMessageId Subsystem2_266638e5_1_deriv(
  const double *,
...
PmfMessageId Subsystem2_266638e5_1_checkDynamics(
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId Subsystem2_266638e5_1_outputDyn(
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId Subsystem2_266638e5_1_outputKin(
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId Subsystem2_266638e5_1_output (
  const double *,
  const double *, const double *, const double *,
  const double *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
void Subsystem2_266638e5_1_resetStateVector(const void *mech, double
  *stateVector);
void Subsystem2_266638e5_1_initializeTrackedAngleState(
  const void *mech,
  const double *motionData,
  double *stateVector,
  void *neDiagMgr);
void Subsystem2_266638e5_1_computeDiscreteState(const void *mech, double
  *stateVector);
void Subsystem2_266638e5_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void Subsystem2_266638e5_1_perturbState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void Subsystem2_266638e5_1_computeDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void Subsystem2_266638e5_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void Subsystem2_266638e5_1_propagateMotion(
  const void *mech,
  const double *stateVector,
  double *motionData);
size_t Subsystem2_266638e5_1_computeAssemblyError(
  const void *mech,
  size_t constraintIdx,
  const double *stateVector,
  const double *motionData,
  double *error);
size_t Subsystem2_266638e5_1_computeAssemblyJacobian(
  const void *mech,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t Subsystem2_266638e5_1_computeFullAssemblyJacobian(
  const void *mech,
  const double *stateVector,
  const double *motionData,
  double *J);
int Subsystem2_266638e5_1_isInKinematicSingularity(
  const void *mech,
  size_t constraintIdx,
  const double *motionData);
PmfMessageId Subsystem2_266638e5_1_convertStateVector(
  const void *asmMech,
  const void *simMech,
  const double *asmStateVector,
  double *simStateVector,
  void *neDiagMgr);
void Subsystem2_266638e5_1_constructStateVector(
  const void *mech,
...
void Subsystem2_266638e5_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
int Subsystem2_266638e5_1_isPositionViolation(
  const void *mech,
  const double *stateVector);
int Subsystem2_266638e5_1_isVelocityViolation(
  const void *mech,
  const double *stateVector);
PmfMessageId Subsystem2_266638e5_1_projectStateSim(
  const void *mech,
  const double *inputVector,
  double *stateVector,
  void *neDiagMgr);
void Subsystem2_266638e5_1_computeConstraintError(
  const void *mech,
  const double *stateVector,
  double *error);
PmfMessageId Subsystem2_266638e5_1_assemble(const double *u, double *udot,
  double *x,
  NeuDiagnosticManager *neDiagMgr)
{
  (void) x;
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = Subsystem2_266638e5_1_deriv(
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 7,
      systemInput->mV.mX + 7,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL && smData->mDoCheckDynamics) {
    double result = 0.0;
    errorId = Subsystem2_266638e5_1_checkDynamics(
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 7,
      systemInput->mV.mX + 7,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[28] = {
    ...
    { 0, 95, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true,
      1, { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },
  ...
  void initIoInfo(NeDaePrivateData *smData)
{
  const char *inputPortPaths[7] = {
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint1.qi",
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint2.qi",
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint3.qi",
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint4.qi",
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint5.qi",
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint6.qi",
    "Subsystem2.Subsystem1.Simulation.Revolute_Joint7.qi"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector = Subsystem2_266638e5_1_resetStateVector;
  delegate->mInitializeTrackedAngleState =
    Subsystem2_266638e5_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState = Subsystem2_266638e5_1_computeDiscreteState;
  delegate->mAdjustPosition = Subsystem2_266638e5_1_adjustPosition;
  delegate->mPerturbState = Subsystem2_266638e5_1_perturbState;
  delegate->mComputeDofBlendMatrix = Subsystem2_266638e5_1_computeDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    Subsystem2_266638e5_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion = Subsystem2_266638e5_1_propagateMotion;
  delegate->mComputeAssemblyError = Subsystem2_266638e5_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    Subsystem2_266638e5_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    Subsystem2_266638e5_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    Subsystem2_266638e5_1_isInKinematicSingularity;
  delegate->mConvertStateVector = Subsystem2_266638e5_1_convertStateVector;
  delegate->mConstructStateVector = Subsystem2_266638e5_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    Subsystem2_266638e5_1_extractSolverStateVector;
  delegate->mIsPositionViolation = Subsystem2_266638e5_1_isPositionViolation;
  delegate->mIsVelocityViolation = Subsystem2_266638e5_1_isVelocityViolation;
  delegate->mProjectStateSim = Subsystem2_266638e5_1_projectStateSim;
  delegate->mComputeConstraintError =
    Subsystem2_266638e5_1_computeConstraintError;
  delegate->mMech = NULL;
}
