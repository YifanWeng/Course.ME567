...
## Generated on : Sat Apr 08 22:30:45 2017
...
DEFINES_ = -DMODEL=untitled -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DUNIX -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=2 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=25 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=6
...
DEFINES_STANDARD = -DMODEL=untitled -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DUNIX
