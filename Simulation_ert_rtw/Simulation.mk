...
## Generated on : Mon Apr 10 11:57:30 2017
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Simulation_ref.rsp
...
DEFINES_ = -DMODEL=Simulation -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DRT -DSTACK_SIZE=64 -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=6 -DMW_SCHEDULERCOUNTER=75 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=6
...
DEFINES_STANDARD = -DMODEL=Simulation -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = Simulation_f1e64dd8_1.o Simulation_f1e64dd8_1_create.o Simulation_f1e64dd8_1_deriv.o Simulation_f1e64dd8_1_checkDynamics.o Simulation_f1e64dd8_1_assembly.o Simulation_f1e64dd8_1_computeConstraintError.o Simulation_f1e64dd8_1_gateway.o pm_printf.o rt_backsubrr_dbl.o rt_forwardsubrr_dbl.o rt_lu_real.o rt_matrixlib_dbl.o Simulation.o hooks.o WInterrupts.o wiring.o wiring_analog.o wiring_digital.o wiring_pulse.o wiring_shift.o abi.o CDC.o HardwareSerial.o HardwareSerial0.o HardwareSerial1.o HardwareSerial2.o HardwareSerial3.o PluggableUSB.o IPAddress.o new.o Print.o Stream.o Tone.o USBCore.o WMath.o WString.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o Servo.o
...
%.o : $(START_DIR)/Simulation_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"
